...
rocks="luasocket luasec redis-lua lua-term oauth serpent dkjson Lua-cURL multipart-post lanes xml fakeredis luaexpat luasec lbase64 luafilesystem lub ansicolors lua-cjson feedparser serpent"
...
pg="lua5.1 luarocks lua-socket lua-sec redis-server curl libnotify-dev lua-lgi libstdc++6 upstart tmux screen g++-4.7 c++-4.7 libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev lua-socket lua-sec lua-expat libevent-dev"
    for rock in $rocks; do
